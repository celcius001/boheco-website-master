...
const rph1 = [
  "assets/rph10/R7 RPH ITB Dist Transformers (PB-ITB-R7-2-2024) (Rebidding)_page-0001.jpg",
  "assets/rph10/R7 RPH ITB Dist Transformers (PB-ITB-R7-2-2024) (Rebidding)_page-0002.jpg",
  "assets/rph10/R7 RPH ITB Dist Transformers (PB-ITB-R7-2-2024) (Rebidding)_page-0003.jpg",
  "assets/rph10/R7 RPH ITB Dist Transformers (PB-ITB-R7-2-2024) (Rebidding)_page-0004.jpg",
  "assets/rph10/R7 RPH ITB Dist Transformers (PB-ITB-R7-2-2024) (Rebidding)_page-0005.jpg",
];
    ...
    <div>
      <section className="pt-8">
        ...
        <span className="font-[Gloock] text-2xl tracking-widest">
          Region 7 RPH Public Bidding No. 2
        </span>
