...
const rph1 = [
  "assets/rph6/Supplemental Bid Bulletin No. 24-06 - Postponement of Bid Opening Date (PB-ITB-R7-4-2024)_page-0001.jpg",
  "assets/rph6/Supplemental Bid Bulletin No. 24-06 - Postponement of Bid Opening Date (PB-ITB-R7-4-2024)_page-0002.jpg",
  "assets/rph6/Supplemental Bid Bulletin No. 24-06 - Postponement of Bid Opening Date (PB-ITB-R7-4-2024)_page-0003.jpg",
];

const rph1Array = [rph1[0], rph1[1], rph1[2]];
