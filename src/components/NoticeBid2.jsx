...
const rph2 = [
  "assets/conductors/S.4_RPH Invitation to Bid - Region 7 Conductors (PB-ITB-R7-4-2024)_page-0001.jpg",
  "assets/conductors/S.4_RPH Invitation to Bid - Region 7 Conductors (PB-ITB-R7-4-2024)_page-0002.jpg",
  "assets/conductors/S.4_RPH Invitation to Bid - Region 7 Conductors (PB-ITB-R7-4-2024)_page-0003.jpg",
  "assets/conductors/S.4_RPH Invitation to Bid - Region 7 Conductors (PB-ITB-R7-4-2024)_page-0004.jpg",
  "assets/conductors/S.4_RPH Invitation to Bid - Region 7 Conductors (PB-ITB-R7-4-2024)_page-0005.jpg",
];

const rph1 = [
  "assets/steelpole/S.3_RPH Invitation to Bid - Region 7 Steel Poles (PB-ITB-R7-3-2024)_1_page-0001.jpg",
  "assets/steelpole/S.3_RPH Invitation to Bid - Region 7 Steel Poles (PB-ITB-R7-3-2024)_1_page-0002.jpg",
  "assets/steelpole/S.3_RPH Invitation to Bid - Region 7 Steel Poles (PB-ITB-R7-3-2024)_1_page-0003.jpg",
  "assets/steelpole/S.3_RPH Invitation to Bid - Region 7 Steel Poles (PB-ITB-R7-3-2024)_1_page-0004.jpg",
  "assets/steelpole/S.3_RPH Invitation to Bid - Region 7 Steel Poles (PB-ITB-R7-3-2024)_1_page-0005.jpg",
];
    ...
    <div>
      <section className="pt-8">
        ...
        <span className="font-[Gloock] text-2xl tracking-widest">
          Region 7 RPH Public Bidding No. 3 Series of 2024
        </span>
      ...
      <section className="pt-8">
        ...
        <span className="font-[Gloock] text-2xl tracking-widest">
          Region 7 RPH Public Bidding No. 4 Series of 2024
        </span>
        <div className="font-[Gloock] text-xl tracking-widest">
          PB-ITB-R7-4-2024
        </div>
