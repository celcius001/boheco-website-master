...
const rph1 = [
  "assets/rph8/R7 RPH ITB Conductors (PB-ITB-R7-4-2024) (Rebidding)_page-0001.jpg",
  "assets/rph8/R7 RPH ITB Conductors (PB-ITB-R7-4-2024) (Rebidding)_page-0002.jpg",
  "assets/rph8/R7 RPH ITB Conductors (PB-ITB-R7-4-2024) (Rebidding)_page-0003.jpg",
  "assets/rph8/R7 RPH ITB Conductors (PB-ITB-R7-4-2024) (Rebidding)_page-0004.jpg",
  "assets/rph8/R7 RPH ITB Conductors (PB-ITB-R7-4-2024) (Rebidding)_page-0005.jpg",
];
    ...
    <div>
      <section className="pt-8">
        ...
        <span className="font-[Gloock] text-2xl tracking-widest">
          Region 7 RPH Public Bidding No. 4
        </span>
